...
val baseCurrency = currencies.getValue(CurrencyCode.USD)

val assetsStorage = mutableListOf(
    Stock(0, "Apple Inc.", 23292, currencies.getValue(CurrencyCode.USD), "AAPL"),
    Stock(1, "Nvidia Corporation", 13491, currencies.getValue(CurrencyCode.USD), "NVDA"),
    Stock(2, "Advanced Micro Devices, Inc.", 18396, currencies.getValue(CurrencyCode.USD), "AMD"),
    Stock(3, "Visa Inc.", 26300, currencies.getValue(CurrencyCode.USD), "V"),
    Bond(
        4,
